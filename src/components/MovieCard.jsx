...
const MovieCard = ({poster_path,id}) => {
  ...
  return (
    <div  className="flex-shrink-0 ">
        <img  onClick={handleCardClick} alt={"movie card"} src={poster}  onError={(e) => e.target.src = poster_placeholder}  className='hover:scale-110 transition-transform duration-400 ease-in-out cursor-pointer xl:w-[15vw]  lg:w-[23vw] md:w-[26vw] sm:w-[34vw] w-[50vw] h-11/12 object-cover'/>
    </div>
  )
}
