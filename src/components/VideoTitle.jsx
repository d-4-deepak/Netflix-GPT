...
const VideoTitle = ({title, overview}) => {
  ...
  return (
    <div  className='w-screen aspect-video absolute  bg-gradient-to-r from-black/40'>
      <div className='pt-[17vw] sm:pt-12 sm:pt-[17vw] md:pt-[19vw] lg:pt-[18vw] px-8 text-white'>
      <p className=' sm:text-[3.4vw] font-bold'>{title}</p>
      <p className='hidden min-[295px]:block py-[10px] sm:py-6 text-[2.3vw] sm:text-[1.5vw] sm:text-[1.2vw] w-2/4 sm:w-1/4'>
